...
class UserAdmin(admin.ModelAdmin):
     list_display = ('id', 'username', 'email', 'first_name', 'last_name', 'mini_bio', 'gender', 'birth_date', 'phone_number', 'created_at', 'updated_at', 'is_staff', 'is_active', 'is_deleted', 'is_archived', 'is_featured', 'is_verified', 'is_published')
